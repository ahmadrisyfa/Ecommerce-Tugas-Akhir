      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="checkbox" wire:model.defer="status"  style="width: 30px;height:30px"> Checked= Sembunyikan, un-Checked= Tampilkan
            @error('status')
            <small class="text-danger">{{ $message }}</small>
            @enderror
          </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" style="font-weight:bold;color:white" data-bs-dismiss="modal">Close</button>
          <button type="submit" class="btn btn-primary" style="font-weight:bold;color:#2f2d2d">Save</button>
        </div>
        </form>
